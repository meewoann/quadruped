...
<<<<<<< HEAD:src/VINS-Fusion-ROS2-humble-arm/vins/src/rosNodeTest.cpp
    if(argc < 2)
=======
    std::vector<std::string> args = rclcpp::remove_ros_arguments(argc, argv);

    if(args.size() != 2)
>>>>>>> 144779d (chore: rename VINS-Fusion-ROS2-humble-arm to vins_fusion):src/vins_fusion/vins/src/rosNodeTest.cpp
    {
